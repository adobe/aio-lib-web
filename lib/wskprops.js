...
// based on serverless-openwhisk, MIT licensed
...
function hasWskConfig(param) {
  const wskFilePath = getWskPropsFile()
  if(param == 'logtestssss'){
    console.log('-------========----------')
    console.log(wskFilePath);
    console.log(fse.existsSync(wskFilePath));
    console.log('##############################################')
  }
  return fse.existsSync(wskFilePath)
}
