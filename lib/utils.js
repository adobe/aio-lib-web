...
async function undeployWsk (packageName, manifestContent, ow, logger) {
  ...
  //    package name
  const entities = await runtimeHelpers.getProjectEntities(packageName, false, ow)
  ...
  entities.apis = runtimeHelpers.processPackage(manifestContent.packages, {}, {}, {}, true).apis
