...
module.exports = () => {
  ...
  // 2.d missing cna hostname
  if (config.app.hasFrontend && !userConfig.cna.hostname) throw new Error('Missing cna.hostname .aio config (or AIO_CNA_HOSTNAME env)')
  ...
  config.app.hostname = userConfig.cna.hostname
