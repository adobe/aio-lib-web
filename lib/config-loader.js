...
const defalt_aio_cna_hostname = 'adobeio-static.net'
...
module.exports = () => {
  ...
  config.actions.devRemote = Boolean(process.env.REMOTE_ACTIONS)
  ...
  config.app.hostname = removeProtocolFormURL(!userConfig.cna.hostname ? defalt_aio_cna_hostname : userConfig.cna.hostname)
